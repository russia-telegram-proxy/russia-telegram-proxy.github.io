...
Ничего устанавливать дополнительно не нужно: все сразу будет работать без VPN и дополнительных приложений.

Получить доступ к прокси серверу можно в боте [@tg_proxy_1bot](https://t.me/tg_proxy_1bot)
...
`#Telegram` `#SOCKS5` `#VPN` `#Приватность` `#Безопасность` `#бесплатно` `#mtproto` `#россия` `#блокировки` `#блокиовка` `#dpi` `#телеграм` `#телега` `#тг`
