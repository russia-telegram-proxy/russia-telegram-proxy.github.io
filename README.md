...
2) Если Телеграм уже не открывается, сначала подключите временный прокси 👉👉 [@fix_telegram_now](tg://socks?server=srv657623423.ftp.sh&port=8441)

3) Настройте в Телеграме: Настройки >> Данные и память >> Настройки прокси >> SOCKS5
